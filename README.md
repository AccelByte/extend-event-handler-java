...
app written in `Java`. It includes examples to handle AGS `userLoggedIn` and `userThirdPartyLoggedIn` events
...
│   │   │       └── accelbyte
│   │   │           └── service
│   │   │               ├── LoginHandler.java              # userLoggedIn event handler
│   │   │               └── ThirdPartyLoginHandler.java    # userThirdPartyLoggedIn event handler
│   │   ├── proto 
